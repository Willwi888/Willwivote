...
// This prevents data from being "washed out" during component renders.
// All lyrics and credits should be defined here.
export const MASTER_SONG_DATA: Record<number, Partial<Song>> = {
  ...
  // ... The logic will use this map to hydrate the songs. 
  // You can populate this list in the code to ensure it persists across sessions.
};
